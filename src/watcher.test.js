...
/**
 * Cleans up a watcher and its associated temp file.
 * Avoids repeating stop + unlink boilerplate in every test block.
 */
function cleanup(watcher, envPath) {
